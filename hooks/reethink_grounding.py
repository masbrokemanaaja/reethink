...
MESSAGE = (
    ...
    "code, security-assessment for vulnerability audits and hardening, "
    "senior-engineer for engineering decisions, and senior-designer for any "
    "UI, UX or visual design, asking whether a color palette exists before "
    "the first one. Label every factual claim "
